...
def convert_article_subtitles_to_lists(context):
    ...
    articles = [brain.getObject() for brain in catalog.unrestrictedSearchResults(portal_type="Article")]
    ...
    for article in articles:
        ...
        if subtitle is None or subtitle == "":
            ...
            article.article_subtitle = list(subtitle) if isinstance(subtitle, tuple) else [subtitle]
