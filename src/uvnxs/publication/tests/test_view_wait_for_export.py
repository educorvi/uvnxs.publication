...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_wait_for_export_is_registered(self):
        view = getMultiAdapter((self.portal["article"], self.portal.REQUEST), name="wait-for-export")
        self.assertTrue(IWaitForExport.providedBy(view))

    def test_wait_for_export_not_matching_interface(self):
        view_found = True
        try:
            view = getMultiAdapter((self.portal["front-page"], self.portal.REQUEST), name="wait-for-export")
